...
// //function thata will handhle the users keyboard input when they press
...
//             let OriginalRow = row.slice(); // to check if row changed
//         row = slide(row);
...
//         let OriginalCol = col.slice(); // to check if col changed
// 		// [2, 8, 0, 0]
// 		col = slide(col);
...
// }
// function slide(row) {
//     row = filterZero(row); // remove all the 0s 
